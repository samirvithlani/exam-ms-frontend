  ...
  const fetchData = async () => {
    try {
      ...
      const sortedData = result.data.sort((a, b) => {
        ...
        const nameA = `${a?.contestparticipant?.userId?.firstname} ${a?.contestparticipant?.userId?.lastname}`.toLowerCase();
        const nameB = `${b?.contestparticipant?.userId?.firstname} ${b?.contestparticipant?.userId?.lastname}`.toLowerCase();
