  ...
  export const UpdateExam = () => {
    ...
    const calculateTotalMarks = (noOfQuestions, perQuestionMarks) => {
      const totalMarks = noOfQuestions * perQuestionMarks;
      setTotalMarksValue(totalMarks);
    };
    ...
    const handleNoOfQuestionsChange = (event) => {
      ...
      calculateTotalMarks(event.target.value, perQuestionMarksValue);
    ...
    const perQuestionmarks = (event)=>{
      ...
      calculateTotalMarks(noOfQuestionsValue, event.target.value);
    ...
    const fetchSubjects = async (streamId) => {console.log(streamId,"stresm id");
      try {
